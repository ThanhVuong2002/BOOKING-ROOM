...
function show(){
    ...
    //   let demo="";
      for (let i=0; i<= hotels.length; i++){
        ...
        if(hotels[i].note == "phongdon"){
            document.getElementById("phongdon").innerHTML +=demo;
        };
        if(hotels[i].note == "phongdoi"){
            document.getElementById("phongdoi").innerHTML+=demo;
        };
        if(hotels[i].note == "phongtongthong"){
            document.getElementById("vip").innerHTML +=demo;
           } 
   }});}
show()
